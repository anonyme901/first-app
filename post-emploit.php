...
if(isset($_POST['article_titre'], $_POST['article_contenu'])) {
   if(!empty($_POST['article_titre']) AND !empty($_POST['article_contenu'])){
      ...
      $ins = $bdd->prepare('INSERT INTO postes (titre, contenu, date_time_publication) VALUES (?, ?,  NOW())');
								...
								<section>
                                    ...
                                    <form method="POST" action="" enctype="multipart/form-data">
                                         ...
                                         <div class="mb-3">
                                            ...
                                            <div id="emailHelp" class="form-text">S'il vous plais n'oublier le nom ☝🏿</div>
                                         </div>
                                         <div class="mb-3">
									...
									<br><br>
										<div class="mb-3">
											<label>Ajouter un profile si ce n'est pas encore fait svp 👉🏿</label>
