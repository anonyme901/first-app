	...
	<body>
        ...
        <div id="page-wrapper">
                ...
                <div class="text-center">
                        <h1 class="p-5">Salut <?php echo $data['pseudo']; ?> !</h1>
                        <hr />
                        ...
                        <br/><br>
                        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#Ajouter_profile">
                          Ajouter profil
                        </button>
                </div>
            </div>
        ...
        <div class="modal fade" id="Ajouter_profile" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Ajouter un profil Monsieur ou Madame 🙂 </h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                         </div>
                            <div class="modal-body">
                                <form action="layouts/change_password.php" method="POST">
                                    <label for='new_password_retype'>Choisire un fichier</label>
					...
					<div class="container">
						...
						<div class="row">
							<div class="col-12">
								...
								<div id="copyright">
									&copy; Chaoussi cherif developpeur web.
								</div>
