						...
						<div class="row">
							<div class="col-12">
								...
								<header id="header">
									...
									<nav id="nav">
										<a href="pageHome.php" class="current-page-item">Page d'accueil</a>
										<a href="jobs.php">Jobs</a>
										<a href="offres.php">Offres d'emploits</a>
										<a href="service.php "> Demandes de services </a>
			...
			<!-- Banner -->
				<div id="banner-wrapper">
					<div class="container">
						...
						<div id="banner">
							<h2>Rien n'emplit mieux une main qu'un sein !</h2>
							<span>On ne travaille pas avec quelqu'un parce qu'il a une veste cool ou des tennis sympas.</span>
						</div>
					...
					<div class="container">
						<div class="row main-row">
							<div class="col-4 col-12-medium">
								...
								<section>
									<h2>Bienvenue chez Togo-freelance</h2>
									<p>Il s'agit de <strong>Togo-freelance</strong>, un site vous permetans de trouver un travail ou un djob en plain temps. Nous
									 vous permetons également de poster un offre d'emploit ou de demander un service peut importe ou vous vous situer</p>
									<footer class="controls">
										<a href="post-emploit.php" class="button">Poster un emploit...</a>
										<a href="post-job.php" class="button">Poster un Djob...</a>
									</footer>
								</section>
							...
							<div class="col-6 col-12-medium">
								...
								<article class="blog-post">
									...
									<a class="comments" href="commentaire.php">33 comments</a>
									...
									<footer class="controls">
										<a href="commentaire.php" class="button">Commentez 😃</a>
									</footer>
								</article>
					...
					<div class="container">
						...
						<div class="row">
							<div class="col-12">
								...
								<div id="copyright">
									&copy; Chaoussi cherif devéloppeur. | Design: <a href="http://html5up.net">HTML5 UP</a>
								</div>
