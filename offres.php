							...
							<div class="col-12">
								...
								<header id="header">
									...
									<nav id="nav">
										...
										<a href="offres.php" class="current-page-item">Offres d'emploits</a>
							...
							<div class="col-4 col-12-medium">
								...
								<section>
									<footer class="controls">
										<a href="post-emploit.php" class="button">Ajouter un offre...</a>
									</footer>
									<br><br>
									<h2>Les offres d'emploit</h2>
									
									<ul class="small-image-list">
									<?php
											$sql = "SELECT * from postes ORDER BY date_time_publication DESC ";
										...
										<li>
											...
											<h4><?php echo stripslashes($row["titre"]) ?></h4>
											<p><?php echo stripslashes($row["contenu"]) ?></p>
											<p><?php echo stripslashes($row["date_time_publication"]) ?></p>
											<br>
