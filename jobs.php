							...
							<div class="col-12">
								...
								<header id="header">
									...
									<nav id="nav">
										...
										<a href="jobs.php" class="current-page-item">Jobs</a>
					...
					<div class="container">
						<div class="row main-row">
							...
							<div class="col-4 col-12-medium">
								...
								<section>
									<h2>Les offres de jobs</h2>
									<ul class="small-image-list">
									<?php
											$sql = "SELECT * from postes2 ORDER BY date_time_publication2 DESC";
										...
										<li>
											...
											<h4><?php echo stripslashes($row["titre2"]) ?></h4>
											<p><?php echo stripslashes($row["contenu2"]) ?></p>
											<p><?php echo stripslashes($row["date_time_publication2"]) ?></p>
										</li>
										<?php
									}
									?>
